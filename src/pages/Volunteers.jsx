...
export default function Volunteers() {
  ...
  const loadData = async () => {
    try {
      ...
      console.log("AUM Volunteers:", volunteersResponse.data);
      console.log("AUM Stats:", statsResponse.data);

      const volunteerData = Array.isArray(
      ...
      setStats({
        total_volunteers:
          statsResponse.data?.total_volunteers ?? 0,

        male:
          statsResponse.data?.male ?? 0,

        female:
          statsResponse.data?.female ?? 0,

        employed:
          statsResponse.data?.employed ?? 0,

        unemployed:
          statsResponse.data?.unemployed ?? 0,
  ...
  // =========================================================
  //
  // ALL passport and QR images go through this function.
  //
  // This prevents the browser from trying:
  //
  // https://aumdutes.vercel.app/uploads/...
  //
  // and instead uses:
  //
  // https://aum-backend-production.up.railway.app/uploads/...
  //
  // =========================================================
  ...
  const getImageUrl = (path) => {
    ...
    try {
      ...
      console.error("Asset URL error:", error, path);
      return "";
    }
  };
  ...
  // =========================================================
  // AUTHENTICATED CARD DOWNLOAD
  // =========================================================

  const downloadVolunteershipCard = async (
    registrationNo
  ) => {
    if (!registrationNo) {
  ...
  const viewVolunteershipCard = async (
    registrationNo
  ) => {
    if (!registrationNo) {
      alert("Registration number is missing.");
    ...
    try {
      ...
      if (error?.response?.status === 401) {
        ...
        alert("Unable to open volunteership card.");
      }
    } finally {
      setCardLoading(false);
    }
  ...
  const printVolunteerPDF = (volunteer) => {
    ...
    const passportUrl = getImageUrl(passportPath);
      ...
      <html>
        ...
        <body>
          ...
          <div class="footer">
            ...
            AUM Volunteer Registration System
  ...
  return (
    <div className="flex min-h-screen bg-[#061A35]">
      ...
      <div className="flex-1 relative overflow-hidden">
        ...
        <div
          className="fixed inset-0 z-0 bg-gradient-to-br from-[#061A35] via-[#064A35] to-[#087A3D]"
        />
                              ...
                              <td className="p-4">
                                ...
                                {imageUrl ? (
                                  ...
                                  <img
                                    ...
                                    className="w-11 h-11 rounded-full object-cover border-2 border-white/20 bg-white"
                                    onError={(event) =>
                                      handleImageError(
                                        event,
                                        passportPath
                          ...
                          <div className="flex items-center gap-4">
                            ...
                            {imageUrl ? (
                              ...
                              <img
                                ...
                                className="w-16 h-16 rounded-2xl object-cover border-2 border-white/20 bg-white"
                                onError={(event) =>
                                  handleImageError(
                                    event,
                                    passportPath
                        ...
                        {(() => {
                          ...
                          return passportUrl ? (
                            <img
                              ...
                              className="w-44 h-44 mx-auto rounded-3xl object-cover border-4 border-white shadow-xl bg-white"
                              onError={(event) =>
                                handleImageError(
                                  event,
                                  passportPath
                          ...
                          {(() => {
                            ...
                            return qrUrl ? (
                              <img
                                ...
                                className="w-32 h-32 mx-auto object-contain bg-white rounded-xl p-2 border"
                                onError={(event) =>
                                  handleImageError(
                                    event,
                                    qrPath
                              ...
                              <div className="w-32 h-32 mx-auto flex items-center justify-center bg-white rounded-xl border">
