...
export default function Volunteers() {
  ...
  const handleSearch = (value) => {
    ...
    const filtered = volunteers.filter((volunteer) => {
      return (
        ...
        volunteer.voter_card_number?.toLowerCase().includes(keyword) ||
  ...
  // =========================================================
  // AUTHENTICATED VOLUNTEERSHIP CARD DOWNLOAD
  // =========================================================
  ...
  // =========================================================
  // AUTHENTICATED VOLUNTEERSHIP CARD VIEW
  // =========================================================
    ...
    const html = `
      ...
      <html>
        <head>
          ...
          <title>
            ${escapeHtml(volunteer.name || "Volunteer")} - AUM
          </title>
        ...
        <body>
          ...
          <div class="profile">
            ...
            <div class="details">
              ...
              ${printItem(
                "Voter's Card Number / VIN",
                volunteer.voter_card_number,
                true
              )}
          ...
          <div class="footer">
            AUM Volunteers Volunteership System
          </div>
                ...
                <div className="flex flex-col lg:flex-row justify-between gap-6">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 mt-5 max-w-2xl leading-relaxed">
                      ...
                      verify voter information, download volunteership cards,
                      and keep the AUM volunteership database organised.
                    </p>
                ...
                <div className="flex flex-col md:flex-row justify-between gap-4">
                  ...
                  <div className="flex gap-3">
                    ...
                    <div className="relative w-full md:w-96">
                      ...
                      <input
                        type="text"
                        placeholder="Search name, reg no, voter card, phone..."
                        value={search}
                        onChange={(e) =>
                            ...
                            <td className="p-4">
                              ...
                              {volunteer.voter_card_number ? (
                                ...
                                <div className="flex items-center gap-2">
                                  ...
                                  <span
                                    className="text-yellow-300 font-semibold max-w-[180px] truncate"
                                    title={volunteer.voter_card_number}
                                  >
                                    {volunteer.voter_card_number}
                                  </span>
                  ...
                  filteredVolunteers.map((volunteer) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="mt-4 rounded-xl bg-yellow-400/10 border border-yellow-400/20 p-3">
                          ...
                          <p className="mt-1 text-sm font-bold text-yellow-300 break-all">
                            {volunteer.voter_card_number ||
                              "Not provided"}
                          </p>
              ...
              <div className="p-6 md:p-8 overflow-y-auto max-h-[calc(92vh-100px)]">
                ...
                <div className="flex flex-col lg:flex-row gap-8">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mb-5 rounded-2xl border-2 border-emerald-100 bg-emerald-50 p-4">
                      ...
                      <div className="mt-3">
                        ...
                        <p className="mt-1 text-lg font-black text-gray-900 break-all">
                          {selectedVolunteer.voter_card_number ||
                            "Not provided"}
                        </p>

                        {!selectedVolunteer.voter_card_number && (
                          <p className="text-xs text-gray-500 mt-1">
                            No voter's card number was provided during registration.
                          </p>
                        )}
...
function printItem(label, value, highlight = false) {
  return `
    <div class="item ${highlight ? "voter" : ""}">
